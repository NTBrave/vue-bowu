     ...
     <div>
       <div class="top">
        ...
        <div class="chooselist">
          ...
          <div class="oldnav">
            <div class="imglist">
                <img src="..\resourse\images\syfz\she2.png" width="15%" @click="actionSheet3">  
            </div>
      ...
      <div class="direclist">
        ...
        <div class="oldlistline" @click="GoItemize">青铜器</div>
      </div>
  ...
  watch: {//监听视频窗口，不存在，将视频路径设为空
      VideopopupVisible(){
        if(this.VideopopupVisible)
         this.playerOptions.sources[0].src = 'http://cdlshow.xyz/resource/syfz.mp4'
        else
